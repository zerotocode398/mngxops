...
PRESET_SETTINGS = [
    ...
    {"key": "node.batch_max_count", "group": "节点管理", "type": "integer", "value": "3",
     "label": "批量操作最大节点数", "description": "节点批量测试/解锁等操作的最大并发节点数", "sort_order": 10},
    ...
    {"key": "node.detect_retries", "group": "节点管理", "type": "integer", "value": "1",
     "label": "节点探测重试次数", "description": "SSH 连接失败时的额外重试次数（不含首次）", "sort_order": 13},
    # 凭证管理
    ...
    {"key": "release.max_parallel_tasks", "group": "发布管理", "type": "integer", "value": "3",
     "label": "最大并行任务数", "description": "批量发布/回滚时 ThreadPoolExecutor 的最大 worker 数", "sort_order": 41},
    ...
    {"key": "system.task_progress_poll_interval", "group": "系统", "type": "integer", "value": "2",
     "label": "任务进度轮询间隔（秒）", "description": "前端轮询任务进度的间隔时间（刷新页面后生效）", "sort_order": 60},
    {"key": "system.dashboard_refresh_interval", "group": "系统", "type": "integer", "value": "30",
     "label": "仪表盘自动刷新间隔（秒）", "description": "仪表盘统计卡片自动刷新间隔（刷新页面后生效）", "sort_order": 61},
    {"key": "system.retention_task_center_days", "group": "系统", "type": "integer", "value": "90",
     "label": "任务中心保留天数", "description": "超过天数的任务中心记录将被自动清理；0 表示不清理", "sort_order": 62},
    {"key": "system.retention_release_history_days", "group": "系统", "type": "integer", "value": "90",
     "label": "发布历史保留天数", "description": "超过天数的发布任务记录将被自动清理；0 表示不清理", "sort_order": 63},
    {"key": "system.retention_audit_log_days", "group": "系统", "type": "integer", "value": "90",
     "label": "操作日志保留天数", "description": "超过天数的操作日志将被自动清理；0 表示不清理", "sort_order": 64},
    {"key": "system.retention_login_log_days", "group": "系统", "type": "integer", "value": "90",
     "label": "登录日志保留天数", "description": "超过天数的登录日志将被自动清理；0 表示不清理", "sort_order": 65},
    # Nginx 编译升级
